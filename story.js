...
display(){
    ...
    this.story.html("Conar is a 26 year old guy who loves nature,he likes gardening and and he has lots of pets.Now he knows that we humans are mmaking a mess on this earth and imbalancing the nature.Now you player has to decide to take a job and work as conar or kill those who bring imbalance to the nature.  ")
    this.story.position(10,windowHeight/2+30)

    this.button.position(windowWidth/2-20,windowHeight/2+100)
